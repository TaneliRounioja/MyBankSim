...
const account={
    ...
    addAccount(newAccount, callback){
        return db.query("INSERT INTO account(idaccount, fname, idcustomer, balance) VALUES(?,?,?,?)", [newAccount.idaccount, newAccount.fname, newAccount.idcustomer, newAccount.balance],callback);
    },
